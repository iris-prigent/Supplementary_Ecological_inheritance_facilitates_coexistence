...
The files "Supplementary_Movie_m_0.8_lambda_0.3.gif", "Supplementary_Movie_m_0.8_lambda_0.7.gif" and "Supplementary_Movie_m_0.8_lambda_0.9.gif" contain the polymorphism-driven spatio-temporal dynamics of the environment, each snapshot representing the environmental quality of all patches in the population. These follow the spatio-temporal dynamics of the environment for 100 generations. The simulations used to represent these dynamics are the same ones used to draw Figure 5 of the main text (see the legend of Figure 5 for parameter values). 
